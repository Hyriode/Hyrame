...
public class HelpCommandCreator {
    ...
    public HelpCommandCreator(String commandPrefix, String commandName, Player player) {
    ...
    public HelpCommandCreator addArgumentsLine(String name, String arguments) {
    ...
    public BaseComponent[] create() {
        ...
        this.builder.append(Symbols.HYPHENS_LINE)
                ...
                .append("\n")
                .strikethrough(false)
                .append(HyrameMessage.AVAILABLE_COMMANDS.asString(account)).color(this.mainColor)
                .append("\n");
        ...
        for (Map.Entry<String, String> entry : this.data.entrySet()) {
            this.builder.append(" ").append(Symbols.DOT_BOLD).color(ChatColor.DARK_GRAY)
                    ...
                    .append(HyriLanguageMessage.get("command." + this.commandName + "." + entry.getKey() + ".description").getValue(account)).color(ChatColor.GRAY)
                    .append("\n");
        }
    ...
    public HelpCommandCreator withMainColor(ChatColor mainColor) {
        this.mainColor = mainColor;
        return this;
    }

    public HelpCommandCreator withSecondaryColor(ChatColor secondaryColor) {
